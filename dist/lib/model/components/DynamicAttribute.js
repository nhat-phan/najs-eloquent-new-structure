...
class DynamicAttribute {
    ...
    static buildKnownAttributes(prototype, bases) {
        return functions_1.array_unique(['knownAttributes', 'dynamicAttributes', 'settings', 'driver'], ['fillable', 'guarded'], ['visible', 'hidden'], ['timestamps'], ['softDeletes'], Object.getOwnPropertyNames(prototype), ...bases.map(base => Object.getOwnPropertyNames(base)));
    }
}
