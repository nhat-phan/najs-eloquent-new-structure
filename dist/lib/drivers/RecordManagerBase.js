...
class RecordManagerBase {
    ...
    buildKnownAttributes(prototype, bases) {
        return functions_1.array_unique(['sharedMetadata', 'internalData', 'attributes', 'driver', 'primaryKey'], ['fillable', 'guarded'], ['visible', 'hidden'], ['schema', 'options'], ['timestamps'], ['softDeletes'], Object.getOwnPropertyNames(prototype), ...bases.map(base => Object.getOwnPropertyNames(base)));
    }
