...
class MongodbQueryBuilderFactory {
    getClassName() {
        return constants_1.NajsEloquent.Driver.Mongodb.MongodbQueryBuilderFactory;
    }
    make(model) {
        return new MongodbQueryBuilder_1.MongodbQueryBuilder(new MongodbQueryBuilderHandler_1.MongodbQueryBuilderHandler(model));
    }
}
MongodbQueryBuilderFactory.className = constants_1.NajsEloquent.Driver.Mongodb.MongodbQueryBuilderFactory;
exports.MongodbQueryBuilderFactory = MongodbQueryBuilderFactory;
najs_binding_1.register(MongodbQueryBuilderFactory, constants_1.NajsEloquent.Driver.Mongodb.MongodbQueryBuilderFactory, true, true);
