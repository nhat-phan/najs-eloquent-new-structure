...
export class MongooseDocumentManager extends RecordManagerBase<Document> {
  getClassName(): string {
    return NajsEloquentClasses.Driver.Mongoose.MongooseDocumentManager
  }
...
register(MongooseDocumentManager, NajsEloquentClasses.Driver.Mongoose.MongooseDocumentManager)
